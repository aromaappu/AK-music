...
fun StorageSettings(
    ...
    // Estado expandido del HorizontalFloatingToolbar (MD3 Expressive)
    ...
    // ✅ Animaciones ligadas al MotionScheme expresivo del tema (spring físico)
    ...
    // ✅ Box raíz para poder superponer el HorizontalFloatingToolbar (MD3 Expressive)
    // sobre el contenido con scroll, siguiendo el patrón oficial de Compose Material3.
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            // Espacio final para que el FloatingToolbar no tape la última tarjeta
        ...
        // ✅ HorizontalFloatingToolbar con FAB vibrante (MD3 Expressive)
        // Acción rápida para vaciar todo el almacenamiento sin salir de la pantalla.
        ...
        Column(
            ...
            Row(
                ...
                Row(
                    ...
                    // ✅ Icono con forma expresiva de MD3 (MaterialShapes) en vez de un
                    // círculo estático: usa la librería oficial de formas expresivas.
                    Surface(
                    ...
                    Column(
                        ...
                        Text(
                            text = title,
                            // ✅ Tipografía "emphasized" de MD3 Expressive
            ...
            if (progress != null) {
                Column(
                    ...
                    // ✅ LinearWavyProgressIndicator: el indicador de progreso lineal
                    // "ondulado" de MD3 Expressive, sustituye al LinearProgressIndicator clásico.
