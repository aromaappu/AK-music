...
-keep class com.aromaappu.akmusic.models.PersistQueue { *; }
-keep class com.aromaappu.akmusic.models.PersistPlayerState { *; }
-keep class com.aromaappu.akmusic.models.QueueData { *; }
-keep class com.aromaappu.akmusic.models.QueueType { *; }
-keep class com.aromaappu.akmusic.playback.queues.** { *; }
